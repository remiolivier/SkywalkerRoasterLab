...
#define MAX31865_CS 4    // Chip Select (CS)
#define MAX31865_MISO 2  // Data output (SDO / MISO)
#define MAX31865_MOSI 3  // Data input (SDI / MOSI)
#define MAX31865_CLK 1   // Clock (SCK)


// Create MAX31865 RTD object
Adafruit_MAX31865 max31865 = Adafruit_MAX31865(
  MAX31865_CS, MAX31865_MOSI, MAX31865_MISO, MAX31865_CLK);


// RTD Settings
#define RREF 430.0      // Reference resistance in ohms
#define RNOMINAL 100.0  // Nominal resistance of the RTD
...
double calculateTemp() {
  // Read raw RTD resistance
  double resistance = max31865.readRTD();

  // Convert resistance to temperature using MAX31865's built-in function
  double temperature = max31865.temperature(100.0, 430.0);  // 100Ω PT100, 430Ω Reference Resistor
...
void handleREAD() {
  String readMsg = "0," + String(temperature) + "," + String(temperature) + "," + String(sendBuffer[HEAT_BYTE]) + "," + String(sendBuffer[VENT_BYTE]) + "\r\n";
  //D_print("READ Output: ");
  //D_println(readMsg);
...
void setup() {
  ...
  max31865.begin(MAX31865_3WIRE);  // Change to MAX31865_3WIRE if using 3-wire RTD
